...
/** FORWARD [steps] - walks the keeper's creature forward. */
public class ForwardCommand extends Command {
    ...
    public Response execute(Shelter shelter, Keeper keeper, Request request) {
        ...
        return Response.ok("moved forward " + steps, StateFactory.from(keeper));
    }
    ...
    public String getHelp() {
        return "FORWARD [steps] - walk forward, default 1 step";
    }
}
